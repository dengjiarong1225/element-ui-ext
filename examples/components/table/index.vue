<template>
  <div class="app-wrapper">
    ...
    <h3>分页</h3>
    <p>前端分页。</p>
    <ext-table :data="frontData" :columns="columns3" pageable :current-page="currentPage" :page-size="pageSize"
               :page-sizes="pageSizes"/>
    <p>后端分页。</p>
    <ext-table :data="asyncData" :columns="columns3" pageable server-side :current-page="currentPage"
    ...
    <el-divider></el-divider>
    <demo-api title="ExtTable Attributes" type="Attributes" :params="AttributesParams"></demo-api>
    <el-divider></el-divider>
    <demo-api title="ExtTable Events" type="Events" :params="EventsParams"></demo-api>
    <el-divider></el-divider>
    <demo-api title="ExtTable Slots" type="Slots" :params="SlotParams"></demo-api>
    <el-divider></el-divider>
    <p>更多参数参考
      element-ui 的
